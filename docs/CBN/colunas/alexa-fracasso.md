...
A Alexa é um dos dispositivos vendidos no varejo que e são acionados por voz, aprendendo com a voz e a dicção do usuário. É possível adicionar vários pacotes de funcionalidades modelando de acordo com a necessidade. 
É possível integrá-la a uma infinidade de dispositivos inteligentes, como lâmpadas, tomadas, fechaduras, videogames, televisões e computadores.
...
As coisas chegaram a esse ponto porque a Alexa tinha uma certa benevolência da empresa. A assistente virtual era o projeto favorito do Jeff Bezzos, que o ex-CEO manteve funcionando mesmo com ela dando um prejuízo enorme.

Segundo informes do site Business Insider, a divisão inteira de dispositivos e serviços está em crise, com a Alexa assumindo o papel de Judas a ser malhado; ex-funcionários citam que o projeto foi "uma oportunidade desperdiçada" para gerar lucros, e "um fracasso imaginativo colossal". Todas as estratégias para monetizar a assistente fracassaram.
...
Este não é um problema exclusivo da Amazon. A Microsoft foi uma das primeiras a pular para fora do barco, e matou a assistente Cortana logo quando viu que não tinha futuro; outrora uma assistente avançadíssima, ela foi capada ao extremo e hoje, é uma sombra de outrora.
